...
def main():
  ...
  # cfg['project_dir'] = '/home/qlan3/projects/def-afyshe-ab/qlan3/projects/Explorer'
  # Sbatch script path
  cfg['script_path'] = './sbatch.sh'
  # Job indexes list
  cfg['job_list'] = list(range(1,900+1))
  ...
  cfg['clusters'] = {'Mp2': 7000}

  make_dir('output/minatar_1')
